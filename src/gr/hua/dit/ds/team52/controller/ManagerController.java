...
public class ManagerController {
    ...
    public String createCompany(WebRequest request ) {
        try {
            ...
            return "Internal parser error. Could not register company";
        }
    ...
    public String updateCompany(WebRequest request ) {
        try {
            String name = request.getParameter("name");
            String username = request.getParameter("username");
            String old_username = request.getParameter("old_username");
            Company company = companyDAO.getCompanyByUsername(old_username);
            companyDAO.saveCompany(company);
        }catch (Exception e){
            return "Internal parser error. Could not update.";
        }
        return "Company Added.";
    }
    ...
    public String deleteCompany (WebRequest request ) {
        try{
            Company company = companyDAO.getCompanyByUsername(request.getParameter("username"));
            companyDAO.deleteCompany(company);
        } catch (Exception e){
            return "Internal parser error. Could not delete.";
        }
