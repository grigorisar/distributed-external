...
<%--                create link to new page for student with current username--%>
                <a href="${pageContext.request.contextPath}/internship/get_bio?username=${tempPet.student_username}" target="_blank"  >BIO</a>
            </td>
...
<div align="center">
    <%--create role--%>
        ...
        <br>
        <form style="display:none" id="petition_accept"  name="petition_accept" method="post" action="${pageContext.request.contextPath}/internship/accept_petition_process">
